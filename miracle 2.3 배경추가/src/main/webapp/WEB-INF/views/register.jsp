							...
							<div class="col-12" style="margin-bottom: 10px;">
								<label for="tell" class="form-label">전화번호*</label>
									...
									<form:input path="user_Tel" class="form-control" id="tell"
										placeholder="(-뺴고 입력)" required="required" />
									
									<form:errors path="user_Tel"/>
									
									<div class="invalid-feedback">Your tel is required.
									</div>
								</div>
							</div>
							...
							<div class="col-12">
								...
								<div class="col-12">
									...
									<form:input path="user_Birth" class="form-control" id="birth"
										placeholder="YYYYMMDD" required="required" />
								...
								<button type="submit" name="registerBtn"
									class="w-100 btn btn-secondary btn-lg">회원가입</button>
					</form:form>
				</div>
			</div>
		</main>
