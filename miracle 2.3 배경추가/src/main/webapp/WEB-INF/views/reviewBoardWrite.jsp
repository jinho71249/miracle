		...
		<div class="row">
			...
			<div class="col-9">
				<div class="d-flex justify-content-between title-containter">
					...
					<label class="main-title">입양 후기</label>
					<div></div>
				</div>
				<br>
				<hr>
				<form:form action="reviewBoardWriteForm"
						...
						<tr>
							<td colspan="2">
								<button type="button" class="btn btn-secondary float-end"
									onclick="location.href='reviewBoard?cur_section=${cur_section}&cur_page=${cur_page}'">취소</button>
								<button type="submit" name="reviewBoardWriteBtn"
									class="btn btn-secondary float-end" style="margin-right:10px;"
									onclick="location.href='reviewBoard?cur_section=${cur_section}&cur_page=${cur_page}'">
									등록</button>
							</td>
						</tr>
					</table>
