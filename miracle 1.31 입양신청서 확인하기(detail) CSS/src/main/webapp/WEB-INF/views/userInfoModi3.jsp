	    ...
	    <button type="submit" name="userInfoModiBtn" class="btn btn-primary btn-lg" style="display:inline-block;"> 회원정보수정 </button> 
	     ...
	     <div class="grid row">
		     <div class="col" style="display:inline-block;">
		    	<button type="reset" class="btn btn-primary btn-lg col-12" > 재작성하기</button>
		    </div>
		    <div class="col" style="display:inline-block;">
	   		 <button type="submit" name="userInfoModiBtn" class="btn btn-primary btn-lg col-12" > 회원정보수정 </button>
	   		</div> 
	    </div>
