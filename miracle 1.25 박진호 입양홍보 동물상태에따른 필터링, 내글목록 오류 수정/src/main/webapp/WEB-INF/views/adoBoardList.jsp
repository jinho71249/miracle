...
<body>
  <div class="main_list">
	...
	<div class="main_title">
      <h1>입양홍보 게시판</h1>
      <a href="<c:url value='/adoBoardWrite'/>">게시글 등록</a>
      <a href="<c:url value='/listAll'/>">전체</a>|<a href="<c:url value='/listProtect'/>">보호중</a>|<a href="<c:url value='/listTP'/>">임시 보호</a>|<a href="<c:url value='/listEnd'/>">입양완료</a>|<a href="<c:url value='/listDead'/>">사망</a>
      <hr>
      ${(cur_section-1)*10+cur_page}페이지
	</div>
	<!-- 리스트 --> 
		...
		<c:if test="${cur_list!=null}">
			<c:forEach items="${cur_list}" var="list">
				<div class="list_detail">
	       			<ul>
	          			<li><a href="<c:url value='/adoBoardDetail?ado_Num=${list.ado_Num}'/>"><img src="${list.ado_AniPic}"></a></li>
