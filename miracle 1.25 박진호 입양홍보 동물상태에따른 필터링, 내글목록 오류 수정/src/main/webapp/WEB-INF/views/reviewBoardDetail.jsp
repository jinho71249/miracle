...
<div>
	...
	<table>
		...
		<td colspan="4">
			<a href="<c:url value='/reviewBoardModi?board_Num=${board.board_Num}&path=${path} '/>">수정</a>/
...
function reviewBoardDel(){
	if(confirm("게시글을 삭제하시겠습니까?")==true){
		location.href='reviewBoardDel?board_Num=${board.board_Num}&cur_section=${cur_section}&cur_page=${cur_page}&path=${path}';
	}
	else{
		return false;
	}
