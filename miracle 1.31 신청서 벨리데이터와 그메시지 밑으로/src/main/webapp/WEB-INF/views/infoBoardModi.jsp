	...
	<div class="container w-100 p-3">
		<div class="row">
			...
			<div class="col-9">
				...
				<form:form action="infoBoardWriteModiForm"
						...
						<tr>
							<td colspan="2">
								<button type="button" class="btn btn-outline-danger float-end"
									onclick="location.href='infoBoardDetail?board_Num=${board.board_Num}&cur_section=${cur_section}&cur_page=${cur_page}'">취소</button>
								<button type="submit" class="btn btn btn-primary float-end"
									name="infoBoardModi">수정</button>
							</td>
						</tr>
					</table>
