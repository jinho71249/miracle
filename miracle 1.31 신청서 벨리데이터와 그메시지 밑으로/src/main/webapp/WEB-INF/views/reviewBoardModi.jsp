	...
	<div class="container w-100 p-3">
		<div class="row">
			...
			<div class="col-9">
				...
				<br>
				<hr>
				<form:form action="reviewBoardModiForm"
						...
						<tr>
							<td colspan="2">
								<button type="button" class="btn btn-outline-danger float-end"
									onclick="location.href='reviewBoardDetail?board_Num=${board.board_Num}&cur_section=${cur_section}&cur_page=${cur_page}'">취소</button>
								<button type="submit" class="btn btn btn-primary float-end"
									name="reviewBoardModi">수정</button>
							</td>
						</tr>
					</table>
