...
public class ReviewBoardController {
	...
	public String reviewBoardModiBtn(
	...
	public String reviewBoardDel(
		...
		if(path!=null&&path.equals("myList?back=review")) {
