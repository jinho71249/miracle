			...
			<div class="col-9">
				...
				<form:form action="adoBoardWriteAfter" enctype="multipart/form-data"
					...
					<div class="input-group">
						...
						<input type="number" name="ado_AniAge" class="form-control" required="required">
					...
					<label style="margin-bottom: 30px;">${numberError}</label> 
					<br>
					...
					<div class="d-flex justify-content-end margin-bottom">
						<button type="button" class="btn btn-secondary btn-margin"
