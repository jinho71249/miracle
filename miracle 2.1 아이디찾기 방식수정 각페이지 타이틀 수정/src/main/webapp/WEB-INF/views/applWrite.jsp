	...
	<div class="row">
		...
		<div class="col-9">
			<div class="d-flex justify-content-between">
				...
				<label class="main-title wordspace"> 입양신청서 작성하기 </label>
				<div></div>
			</div>
			<hr>
			<br>
								...
								<div class="row g-5">
									...
									<form:form action="applWriteAfter" modelAttribute="appl"
										...
										<div class="col-sm-12">
											...
											<form:input path="appl_Name" class="form-control"
												id="appName" required="required" />
											...
											<div class="col-sm-12">
												<label for="age" class="form-label wordspace"> 나이 *
													(미성년자는 보호자의 동의가 필요합니다)</label>
											...
											<div class="col-12">
												...
												<form:input path="appl_Email" class="form-control"
													id="email" placeholder="miracle@miracle.com" />
											...
											<div class="col-12">
												<label for="applContact" class="form-label">연락 가능
													시간*</label>
											...
											<div class="col-12">
												...
												<form:input path="appl_Job" class="form-control"
													id="applJob" />
											...
											<div class="grid row justify-content-md-center">
												...
												<button type="button"
													class="btn btn-secondary btn-lg col-3 me-1"
													onclick="location.href='adoBoardDetail?ado_Num=${appl.appl_Ado_Num}&cur_section=${cur_section}&cur_page=${cur_page}'">취소
												</button>
												<button type="submit" class="btn btn-secondary btn-lg col-3" style="margin-left: 5px;">
													입양신청하기</button>
											</div> 
										</div>
									</form:form>
