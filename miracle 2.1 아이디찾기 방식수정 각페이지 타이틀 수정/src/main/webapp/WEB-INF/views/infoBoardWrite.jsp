		...
		<div class="row">
			...
			<div class="col-9">
				<div class="d-flex justify-content-between title-containter">
					...
					<label class="main-title">정보 공유</label>
					<div></div>
				</div>
				<br>
				<hr>
				<form:form action="infoBoardWriteForm" enctype="multipart/form-data"
						...
						<tr>
							<td colspan="2">
								<button type="button" class="btn btn-secondary  btn-sm float-end" 
									onclick="location.href='infoBoardList?cur_section=${cur_section}&cur_page=${cur_page}'">취소</button>
								<button type="submit" name="infoBoardWriteBtn" style="margin-right:10px;"
									class="btn btn-secondary  btn-sm float-end"
									onclick="location.href='infoBoardList?cur_section=${cur_section}&cur_page=${cur_page}'">
									등록</button>
							</td>
						</tr>
					</table>
