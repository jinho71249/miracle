	...
	<div class="container">
		<main>
			...
			<form:form action="register" modelAttribute="data"  class="needs-validation"> 
				...
				<div class="row g-3 ">
           			 <div class="col-sm-12">
           			   <label for="firstName" class="form-label text-center"> 아이디* </label>
              ...
              <div class="input-group has-validation">
                <!-- <span class="input-group-text">@</span> -->
	   			 <form:input path="user_Name" class="form-control" id="username" placeholder="홍길동" required="required"/>
			...
			<hr class="my-4">
				...
				<input type="checkbox" name="agree" value="true" required="required"  class="form-check-input" id="same-address">
	   			...
	   			<label class="form-check-label" for="same-address">개인정보 수집 및 이용에 동의합니다</label>
	    <br>
				
		 <hr class="my-4">
				<button type="submit" name="registerBtn" class="w-100 btn btn-primary btn-lg">회원가입</button>
			</form:form>
			 </div>
 		   </div>
		</main>
