				...
				<div class="container px-4 py-5" id="featured-3">
					...
					<div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
						<div class="feature col bg-light p-3 rounded">
							...
							<p>이때 주인이 없는 동물일 경우 다소 난감하게 대하는 동물의사도 있습니다. 치료비 때문이라기보다는 동물의 사후 처리에 대해 곤혹스러운 마음이 들어서일 것입니다. 먼저 동물을 병원에 버리고 가지 않는다는 신뢰를 줄 수 있도록 잘 설득하시고, 치료비 일부라도 지불해 응급처치를 받을 수 있게 해주십시오.</p>
						...
						<div class="feature col bg-light p-3 rounded">
							...
							<p>
대부분의 목격자들이 동물 이송을 난감해 하는데 이는 그리 어려운 일이 아닙니다. 마음을 진정시키고 다음과 같이 침착하게 대처해 주십시오. 작은 동물일 경우 그대로 품에 안아서 택시를 이용하는 방법도 있으며, 조금 큰 동물은 주변의 상가나 주변인에게 도움을 요청, 종이 박스 같은 것에 담아서 이송하는 방법도 있습니다. 이때 동물이 구토, 설사, 출혈 등의 경우도 있으므로 반드시 타월이나 신문지, 비닐봉투 등을 준비하시기 바랍니다.</p>
							<!-- <a href="#" class="icon-link d-inline-flex align-items-center">
								Call to action <svg class="bi" width="1em" height="1em">
									<use xlink:href="#chevron-right" /></svg>
							</a> -->
						...
						<!-- 		<svg class="bi" width="1em" height="1em">
							...
							<p> 통증 때문에 난폭한 행동을 할 수 있으므로 119에 도움을 요청하십시오. 지역에 따라 119가 출동하기를 난감해 하는 경우도 있습니다. 그럴 경우, 난폭한 개를 보통의 사람이 이송할 경우 인재로 이어지게 되면 어차피 119가 출동해야 한다는 것을 주지시키고, 사전 예방을 위한 조치라는 것을 잘 설득하셔서 도움을 받으십시오.</p>
							<!-- <a href="#" class="icon-link d-inline-flex align-items-center">
								Call to action <svg class="bi" width="1em" height="1em">
									<use xlink:href="#chevron-right" /></svg>
							</a> -->
...
모든 동물 단체는 늘어만 가는 집 없는 동물로 인해 한계상황에 처해 있고, 누구에게나 임시보호는 힘에 겨운 일입니다. 가여운 생명을 외면하지 말고 조금만 더 적극적인 입장을 취해 주시기 바랍니다. 그러나 도저히 그럴 입장이 안 되시면 동물 구조 단체에 도움을 요청하십시오. 동물단체가 성의껏 도와줄 것입니다.							<!-- <a href="#" class="icon-link d-inline-flex align-items-center">
								Call to action <svg class="bi" width="1em" height="1em">
									<use xlink:href="#chevron-right" /></svg>
							</a> -->
						</div>
	...
	<!-- ===================================여기서부터 두번째 내용 ======================================== -->
			...
			<div class="px-4 py-5 my-5 text-center" style="margin:0; padding:0;">
				<!-- <img class="d-block mx-auto mb-4" src="/docs/5.2/assets/brand/bootstrap-logo.svg" alt="" width="72" height="57"> -->
				<!-- <img src="./img/logo.png" style="width:12%;height:12%; display:hidden;" > -->
				<div class="mx-auto" style="text-align: center;">
					<img src="./img/logo.png" style="width: 12%; height: 12%;"
