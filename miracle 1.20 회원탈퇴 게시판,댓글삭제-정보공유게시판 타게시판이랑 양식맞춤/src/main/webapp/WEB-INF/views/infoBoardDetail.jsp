...
<h1>정보공유게시판 상세보기</h1>
	...
	<table>
		...
		<td colspan="4">
			<a href="<c:url value='/infoBoardModi?board_Num=${board.board_Num} '/>">수정</a>/
	...
	<button type="button" onclick="location.href='infoBoardList?cur_section=${cur_section}&cur_page=${cur_page}'">목록으로 돌아가기</button>
</div>
<div>
