...
public class ReviewBoardController {
	...
	public String reviewBoardWriteForm(@RequestParam(value="file") MultipartFile file, Board board,Errors errors,Model model) {
	...
	public String reviewBoardModi(@RequestParam(value="file") MultipartFile file,Board board,Errors errors,Model model) {
		String fileName="";
		if(!file.isEmpty()) {
			fileName=file.getOriginalFilename();
			String path=fileName;
