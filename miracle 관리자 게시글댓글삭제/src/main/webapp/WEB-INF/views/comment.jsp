...
<body>
		...
		<form:form action="commentWrite" modelAttribute="comment">
			...
			<div class="card-body position-relative">
				...
				<button type="submit" name="commentBtn"
					class="btn btn-primary btn-lg margin-bottom" style="float: right;">댓글
					등록하기</button>
			</div>
							...
							<c:choose>
								<c:when test="${curLogin.user_Admin==1}">
									<button type="button" style="margin-right:5px;" 
											class="btn btn-primary btn-lg margin-bottom float-end" id="d${index.count}"
								...
								<c:otherwise>
									<button type="button" id="m${index.count}"
										...
										class="btn btn-primary btn-lg margin-bottom" style="float: right;"> 
										수정/삭제 비밀번호 확인</button>
									
									<button type="submit" style="display: none; float: right;"
										id="s${index.count}" class="btn btn-primary btn-lg margin-bottom">수정</button>
			
									<button type="button" style="display: none; float: right; margin-right: 5px;"
										class="btn btn-primary btn-lg margin-bottom" id="d${index.count}"
	...
	<c:if test="${empty comments}">
		<div class="card" style="width: 80%; margin:auto">
			<div class="card-body fs-5">등록된 댓글이 없습니다</div>
		</div>
	</c:if>
