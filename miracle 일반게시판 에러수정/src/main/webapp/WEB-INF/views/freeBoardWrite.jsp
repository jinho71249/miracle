...
<!-- 입양후기 글 작성페이지 -->
  ...
  <div class="col-9">
    ...
    <%-- <form action="reviewBoardWriteForm" method="POST" enctype="multipart/form-data"> --%>
      <form:form action="freeBoardWriteForm" enctype="multipart/form-data" modelAttribute="board">
...
<!--             <textarea rows="30" cols="75" name="board_Content" ></textarea> -->
        ...
        <tr>
          <td colspan="2"> 
            <button type="button" class="btn btn-outline-danger float-end" onclick="location.href='freeBoard?cur_section=${cur_section}&cur_page=${cur_page}'">취소</button>
            <button type="submit" name="freeBoardWriteBtn" class="btn btn btn-primary float-end" onclick="location.href='freeBoard?cur_section=${cur_section}&cur_page=${cur_page}'"> 등록</button>
          </td>
        </tr>
      </table>
    </form:form>
