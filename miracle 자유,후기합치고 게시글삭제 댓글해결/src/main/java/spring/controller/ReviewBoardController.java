...
public class ReviewBoardController {
	...
	public String reviewBoard(Model model,@RequestParam("cur_section") String section,@RequestParam("cur_page") String page,HttpSession session) {
...
//				if(board.getBoard_Pic()!=null) {
//					path=board.getBoard_Pic()+path+fileName+"&";
//				}else {
//					path=path+fileName+"&";
//				}
