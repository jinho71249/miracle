...
<body>
  <div class="main_list">
	...
	<div class="main_title">
      <h1>자유 게시판</h1>
      <a href="#">게시글 등록</a>
      <a href="#">사진</a>|게시글 제목<a href="#">작성자</a>|<a href="#">조회수</a>
      <hr>
	</div>
	<!-- 리스트 --> 
		...
		<c:if test="${cur_list!=null}">
			<c:forEach items="${cur_list}" var="list">
				<div class="list_detail">
	       			<ul>
	          			<li><a href="<c:url value='/adoBoardDetail?ado_Num=${list.ado_Num}&cur_section=${cur_section}&cur_page=${cur_page}'/>"><img src="${list.ado_AniPic}"></a></li>
