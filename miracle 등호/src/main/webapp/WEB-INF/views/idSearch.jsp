		...
		<form:form action="idSearchCom" modelAttribute="data">
			...
			<div class="form-floating">
			 ...
			 <!-- <input type="tel" name="user_Tel" required> -->
				<div class="form-floating">
					<form:input path="user_Tel"  class="form-control" id="floatingTel" placeholder="전화번호"/>
					<form:errors path="user_Tel"/>
					<label for="floatingTel">전화번호</label>
				</div><br>
			<!-- <input type="text" name="user_Birth" required> -->
				<div class="form-floating">
					<form:input path="user_Birth" class="form-control" id="floatingBirth" placeholder="생년월일"/>
