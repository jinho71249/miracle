...
<div>
	...
	<table>
		...
		<td colspan="4">
			<a href="<c:url value='/freeBoardModi?board_Num=${board.board_Num} '/>">수정</a>/
	...
	<button type="button" onclick="location.href='freeBoard?cur_section=${cur_section}&cur_page=${cur_page}'">목록으로 돌아가기</button>
</div>
</body>
