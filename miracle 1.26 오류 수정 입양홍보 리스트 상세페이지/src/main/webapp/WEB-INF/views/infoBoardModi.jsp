...
<!--             <textarea rows="30" cols="75" name="board_Content" ></textarea> -->
        ...
        <tr>
          <td colspan="2"> 
             <button type="button" onclick="location.href='infoBoardDetail?board_Num=${board.board_Num}&cur_section=${cur_section}&cur_page=${cur_page}&path=${path}'">취소</button>
            <button type="submit" name="infoBoardModi"> 수정</button>
          </td>
        </tr>
      </table>
