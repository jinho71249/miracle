 ...
 <main>
  ...
  <div class="row justify-content-md-center">
	<div class="card justify-content-md-center" style="width: 50rem;">
	  <img src="${appl.appl_Ado_AniPic}" class="card-img-top" alt="입양동물사진" >
	  <div class="card-body">
	    ...
	    <form:form action="applWriteAfter" modelAttribute="appl" method="post" class="needs-validation" novalidate="novalidate"> 
			...
			<div class="row g-3 ">
		        <div class="col-sm-12">
		         <label for="appId" class="form-label text-center"> 신청인아이디 </label>
				 <form:input path="appl_Id" class="form-control" id="appId" readonly="true"/><br>
				</div>
			</div>
			
			<div class="col-sm-12">
			 <label for="appName" class="form-label"> 신청인 성명 *</label>
			<form:input path="appl_Name" class="form-control" id="appName" required="required"/>
				  	  <form:errors path="appl_Name"/> <br>
				  	  
			<div class="col-sm-12">
			<label for="password" class="form-label"> 성별 *</label>	<br>
			<span class="class="form-control">	  
			 <form:radiobutton path="appl_Gender" value="0" class="form-check-input"/>&nbsp&nbsp남성 
			 &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
			<form:radiobutton path="appl_Gender" value="1" class="form-check-input"/>&nbsp&nbsp여성 <br>
			</span>  
			</div><br>
			
			 <div class="col-sm-12">
			  <label for="age" class="form-label"> 나이 * (미성년자는 보호자의 동의가 필요합니다)</label>
		...
		<br>
	        ...
	        <div class="col-12">   
			 ...
			 <form:input path="appl_Contact" class="form-control" id="applContact"/>
	        ...
	        <div class="col-12">   
			 ...
			 <form:input path="appl_Addr" class="form-control" id="applAddr"/>
			...
			<span class="class="form-control">	  
			 <form:radiobutton path="appl_Mar" value="0" class="form-check-input"/>&nbsp&nbsp 미혼
			 &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
			<form:radiobutton path="appl_Mar" value="1" class="form-check-input"/>&nbsp&nbsp  기혼 <br>
			</span>  
			</div><br>
		...
		<div class="grid row justify-content-md-center">
			<button type="submit" class="btn btn-primary btn-lg col-6"> 입양신청하기 </a>
		</div>	
		</form:form>	 
	...
	<!--  <footer class="my-5 pt-5 text-muted text-center text-small">
	 ...
	 <%-- <img alt="동물사진" src="${appl.appl_Ado_-AniPic}"> --%>
	<%-- <form:form action="applWriteAfter" modelAttribute="appl" method="post"> 
		<form:hidden path="appl_Ado_Num"/>
		<form:hidden path="appl_Ado_AniPic"/>
		<br>
		신청인 아이디 <form:input path="appl_Id" readonly="true"/><br>
