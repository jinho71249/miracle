		...
		<form:form action="commentWrite" modelAttribute="comment">
			...
			<div class="card-body position-relative">
				...
				<button type="submit" name="commentBtn"
					class="btn btn-primary btn-lg " style="float: right;">댓글
					등록하기</button>
			</div>
			...
			<div class="card" style="width: 80%; margin:auto">
				...
				<form:form action="commentUpdate" modelAttribute="comment">
					...
					<%-- 	<textarea class="form-control" style="height: 100px;"
							id="${index.count}" name="com_Con" readonly>   
			            ${com.com_Con}
			            </textarea> --%>
						<!-- </div> -->
						<!-- 		</h5> -->
						...
						<button type="submit" style="display: none; float: right; "
							id="s${index.count}" class="btn btn-primary btn-lg">수정</button>

						<button type="button" style="display: none; float: right;"
							class="btn btn-primary btn-lg" id="d${index.count}"
