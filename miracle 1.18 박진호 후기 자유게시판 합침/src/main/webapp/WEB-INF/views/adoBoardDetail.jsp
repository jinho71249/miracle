...
<div>
		...
		<div>
			<button type="button"
				onclick="location.href='applWrite?ado_Num=${info.ado_Num}&ado_AniPic=${info.ado_AniPic}'">입양신청</button>
			<!-- 입양신청서 이동-->
		</div>
		...
		<table>
			...
			<tr>
				<c:if test="${info.ado_User_Id==curLogin.user_Id}">
					<td colspan="2">
						<button type="button"
							onclick="location.href='adoBoardModi?ado_Num=${info.ado_Num}&ado_AniPic=${info.ado_AniPic}'">수정</button>
			...
			<tr>
				<td>
					<button type="button" onclick="location.href='adoBoardList'">목록으로
						돌아가기</button>
				</td>
			</tr>
		</table>
