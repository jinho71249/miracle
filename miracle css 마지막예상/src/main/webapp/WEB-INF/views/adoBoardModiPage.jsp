	...
	<div class="container w-100 p-3">
		<div class="row">
			...
			<div class="col-9">
				...
				<br>
				<hr>
				<form:form action="adoBoardModiAfter" enctype="multipart/form-data"
					modelAttribute="adoption">

					<div class="input-group mb-3 filebox preview-image margin-top">
					...
					<div class="d-flex justify-content-end margin-bottom">
						<button type="button" class="btn btn-secondary btn-sm btn-margin"
							onclick="location.href='adoBoardDetail?ado_Num=${num}&path=${path}'">취소</button>
