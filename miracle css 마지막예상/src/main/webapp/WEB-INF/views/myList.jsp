...
<body class="container w-100 p-3">
	...
	<div class="row">
		...
		<div class="col-9">
			<div class="d-flex justify-content-between">
				...
				<label class="main-title wordspace"> 내 글 목록보기 </label>
				<div></div>
			</div>
			...
			<div>
				...
				<ul
					class="nav nav-pills nav-fill nav-justified flex-column flex-sm-row list-group">


					<li class="nav-item list-group-item-action"><a
						class="nav-link" href="#" onclick="getMyAdo()"> 입양홍보 </a></li>
					<li class="nav-item list-group-item-action"><a
						class="nav-link" href="#" onclick="getMyApplGet()"> 내게 온 신청서 </a></li>
					<li class="nav-item list-group-item-action"><a
						class="nav-link" href="#" onclick="getMyApplSent()"> 작성한신청서 </a></li>
					<li class="nav-item list-group-item-action"><a
						class="nav-link" href="#" onclick="getMyReview()"> 입양후기 </a></li>
					<li class="nav-item list-group-item-action"><a
						class="nav-link" href="#" onclick="getMyInfo()"> 정보공유 </a></li>
					<li class="nav-item list-group-item-action"><a
						class="nav-link" href="#" onclick="getMyFree()"> 자유게시판 </a></li>
				</ul>
			</div>
