...
public class RegisterController {
	private UserRegisterService userRegisterSvc;
	
	public RegisterController(UserRegisterService userRegisterSvc) {
		this.userRegisterSvc = userRegisterSvc;
	}
