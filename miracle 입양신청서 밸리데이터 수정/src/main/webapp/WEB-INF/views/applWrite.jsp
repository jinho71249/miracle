...
<div class="d-flex justify-content-between">
				...
				<label class="main-title"> 입양신청서 작성하기 </label>
				<div></div>
			</div>
			<hr>
<br>
							...
							<form:form action="applWriteAfter" modelAttribute="appl"
								...
								<div class="col-sm-12">
									...
									<div class="grid row justify-content-md-center">
										<button type="button" class="btn btn-secondary btn-lg col-3 me-1"
			                                 onclick="location.href='adoBoardDetail?ado_Num=${appl.appl_Ado_Num}&cur_section=${cur_section}&cur_page=${cur_page}'">취소
			                           </button>
										<button type="submit" class="btn btn-secondary btn-lg col-3">
											입양신청하기</button>
									</div>
								</div>
							</form:form>
